...
def model(LOSS, OPT, dropout_ALPHA):
	...
	res3 = res_block(active5, 2048)
	active6 = Activation('relu')(res3)

	dropout3 = Dropout(dropout_ALPHA)(active6)
	dense4 = Dense(1024)(dropout3)
	active7 = Activation('relu')(dense4)

	res4 = res_block(active7, 1024)
	active8 = Activation('relu')(res4)

	res5 = res_block(active8, 1024)
	active9 = Activation('relu')(res5)

	dropout4 = Dropout(dropout_ALPHA)(active9)
	dense5 = Dense(512)(dropout4)
	active10 = Activation('relu')(dense5)

	res6 = res_block(active10, 512)
	active11 = Activation('relu')(res6)

	res7 = res_block(active11, 512)
	active12 = Activation('relu')(res7)

	dropout5 = Dropout(dropout_ALPHA)(active12)
	dense6 = Dense(256)(dropout5)
	active13 = Activation('relu')(dense6)

	res8 = res_block(active13, 256)
	active14 = Activation('relu')(res8)

	dropout6 = Dropout(dropout_ALPHA)(active14)
	dense7 = Dense(1)(dropout6)
	active15 = Activation('sigmoid')(dense7)

	model = Model(inputs=[input1,input2], outputs=active15)
