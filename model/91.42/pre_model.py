...
def model(LOSS, OPT, dropout_ALPHA):
	...
	embedding = Embedding(18375, 256, input_length=(10,))(input2)
	...
	dense2 = Dense(2048)(dropout1)
	active2 = Activation('relu')(dense2)

	dropout2 = Dropout(dropout_ALPHA)(active2)
	dense3 = Dense(1024)(dropout2)
	active3 = Activation('relu')(dense3)

	res1 = res_block(active3, 1024)
	active4 = Activation('relu')(res1)

	res2 = res_block(active4, 1024)
	active5 = Activation('relu')(res2)

	dropout3 = Dropout(dropout_ALPHA)(active5)
	dense4 = Dense(512)(dropout3)
	active6 = Activation('relu')(dense4)

	res3 = res_block(active6, 512)
	active7 = Activation('relu')(res3)

	res4 = res_block(active7, 512)
	active8 = Activation('relu')(res4)

	dropout4 = Dropout(dropout_ALPHA)(active8)
	dense5 = Dense(256)(dropout4)
	active9 = Activation('relu')(dense5)

	res5 = res_block(active9, 256)
	active10 = Activation('relu')(res5)

	res6 = res_block(active10, 256)
	active11 = Activation('relu')(res6)

	dropout6 = Dropout(dropout_ALPHA)(active11)
	dense6 = Dense(1)(dropout6)
	active12 = Activation('sigmoid')(dense6)
