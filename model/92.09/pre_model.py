...
def model(LOSS, OPT, dropout_ALPHA):
	...
	embedding = Embedding(18375, 64, input_length=(10,))(input2)
	...
	res2 = res_block(active4, 256)
	active5 = Activation('relu')(res2)

	dropout3 = Dropout(dropout_ALPHA)(active5)
	dense4 = Dense(128)(dropout3)
	active6 = Activation('relu')(dense4)

	res3 = res_block(active6, 128)
	active7 = Activation('relu')(res3)

	dropout4 = Dropout(dropout_ALPHA)(active7)
	dense5 = Dense(1)(dropout4)
	active8 = Activation('sigmoid')(dense5)

	model = Model(inputs=[input1,input2], outputs=active8)
